  ...
  <div class="content">
    <div class="container_12">
        ...
        <ul class="list1">
          <li>
            ...
            <div class="extra_wrapper">
              <div class="text1"><a href="#">Shruti </a></div>
             she is the guide of rajstan in camping site </div>
          </li>
          <li>
            <div class="count">2</div>
            <div class="extra_wrapper">
              <div class="text1"><a href="#">Vaishnavi  </a></div>
              she is the guide of Himachal pradesh in camping site</div>
          </li>
          <li>
            <div class="count">3</div>
            <div class="extra_wrapper">
              <div class="text1"><a href="#">Pinku </a></div>
            she is the guide of Rishikesh in camping site</div>
          </li>
        </ul>
      </div>
      <div class="clear"></div>
      ...
      <div class="grid_9">
        ...
        <ul class="list2">
          <li><a href="#">7:30 am wake up </a></li>
          <li><a href="#">8:15 am break fast</a></li>
          <li><a href="#">9:00 morning activities </a></li>
          <li><a href="#">12:00 pm lunch</a></li>
          <li><a href="#">1:00 pm Rest period and afternoon activities</a></li>
        </ul>
        <ul class="list2">
          <li><a href="#">4:30 pm general swim and free time  </a></li>
          <li><a href="#">6:00 pm dinner time</a></li>
          <li><a href="#">7:30 pm After dinner activities</a></li>
          <li><a href="#">9:30 pm Lights out </a></li>
        </ul>
        <div class="clear"></div>
      </div>
      <div class="grid_3">
        ...
        <blockquote>
          <p class="text1"> “ Once all the power goes out, there will still be human beings standing together around a campfire, playing acoustic guitars”</p>
          <div class="bq_bot">
               <div class="text1">Nikita</div>
           </div>
        </blockquote>
      </div>
      <div class="clear"></div>
